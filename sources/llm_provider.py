...
class Provider:
    def __init__(self, provider_name, model, server_address="127.0.0.1:5000", is_local=False, api_key=None):
        ...
        self.unsafe_providers = ["openai", "anthropic", "groq", "deepseek", "dsk_deepseek", "together", "google", "openrouter"]
