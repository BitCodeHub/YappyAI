...
class AgentRouter:
    ...
    def learn_few_shots_complexity(self) -> None:
        ...
        few_shots = [
            ...
            ("I want you to make me a plan to travel to Tainan", "LOW"),
            ("Plan my trip to New York from July 11-21", "LOW"),
            ("Give me a travel itinerary for visiting Paris", "LOW"),
            ("I need a vacation plan for Hawaii next month", "LOW"),
            ("Create a comprehensive travel itinerary for Tokyo", "LOW"),
