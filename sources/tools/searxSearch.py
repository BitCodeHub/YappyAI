...
class searxSearch(Tools):
    def __init__(self, base_url: str = None):
        ...
        self.base_url = base_url or os.getenv("SEARXNG_BASE_URL", "https://search.ononoki.org")  # Use public SearxNG instance
        ...
        # Note: Now uses public SearxNG instance as fallback, no error needed
    ...
    def execute(self, blocks: list, safety: bool = False) -> str:
        ...
        try:
            ...
            return f"Web search failed: {str(e)}. Please check internet connection."
